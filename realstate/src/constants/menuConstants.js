...
export const MENU_REVIEW_SAVE_REQUEST = 'MENU_REVIEW_SAVE_REQUEST';
export const MENU_REVIEW_SAVE_SUCCESS = 'MENU_REVIEW_SAVE_SUCCESS';
export const MENU_REVIEW_SAVE_FAIL = 'MENU_REVIEW_SAVE_FAIL';
export const MENU_REVIEW_SAVE_RESET = 'MENU_REVIEW_SAVE_RESET';